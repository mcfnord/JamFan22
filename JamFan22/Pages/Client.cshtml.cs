            ...
            get
            {
                ...
                switch (NationCode)
                {
                    case "CN": case "TW": case "HK": return
                        ...
                        $"<li>如要将您的服务器从此列表中完全移除，还需屏蔽 {ipLon1} 和 {ipLon2}。</li></ul>" +
                    ...
                    case "TH": return
                        ...
                        $"<li>หากต้องการลบเซิร์ฟเวอร์ของคุณออกจากรายการนี้ทั้งหมด ให้บล็อก {ipLon1} และ {ipLon2} ด้วย</li></ul>" +
                    ...
                    case "DE": return
                        ...
                        $"<li>Um deinen Server vollständig aus dieser Liste zu entfernen, blockiere außerdem {ipLon1} und {ipLon2}.</li></ul>" +
                    ...
                    case "IT": return
                        ...
                        $"<li>Per rimuovere completamente il tuo server da questo elenco, blocca anche {ipLon1} e {ipLon2}.</li></ul>" +
                    ...
                    case "ES": case "MX": case "AR": case "CO": case "CL": case "PE": case "VE": case "EC": case "GT": case "CU": case "BO": case "DO": case "HN": case "PY": case "SV": case "NI": case "CR": case "PA": case "UY": return
                        ...
                        $"<li>Para eliminar completamente tu servidor de esta lista, bloquea también {ipLon1} y {ipLon2}.</li></ul>" +
                    ...
                    case "NL": return
                        ...
                        $"<li>Om jouw server volledig uit deze lijst te verwijderen, blokkeer ook {ipLon1} en {ipLon2}.</li></ul>" +
                    ...
                    case "FR": case "BE": case "CH": return
                        ...
                        $"<li>Pour retirer complètement votre serveur de cette liste, bloquez également {ipLon1} et {ipLon2}.</li></ul>" +
                    ...
                    default: return
                        ...
                        $"<li>To remove your server from this list entirely, also block {ipLon1} and {ipLon2}.</li></ul>" +
